...
* Le cas MPS (à merger dans l'étude bibliographique)
...
** Modèles dans les GPL et les domaines (à merger dans l'étude bibilographique ???)
** Du métamophisme via le domaine
** Pourquoi s'intéresser aux annotations ?
